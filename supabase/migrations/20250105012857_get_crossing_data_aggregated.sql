  ...
  RETURN QUERY
    WITH aggregated_data AS (
      SELECT
        ...
        ROUND(AVG(ts.route_speed))::FLOAT AS minute_avg_speed,
        ROUND(MIN(ts.route_speed))::FLOAT AS minute_min_speed,
        ROUND(MAX(ts.route_speed))::FLOAT AS minute_max_speed,
        ROUND(AVG(ts.route_travel_time))::FLOAT AS minute_avg_travel_time,
        ROUND(MIN(ts.route_travel_time))::FLOAT AS minute_min_travel_time,
        ROUND(MAX(ts.route_travel_time))::FLOAT AS minute_max_travel_time
    ...
    SELECT
      ...
      ROUND(AVG(minute_avg_speed))::FLOAT AS avg_speed,
      ROUND(MIN(minute_min_speed))::FLOAT AS min_speed,
      ROUND(MAX(minute_max_speed))::FLOAT AS max_speed,
      ROUND(AVG(minute_avg_travel_time))::FLOAT AS avg_travel_time,
      ROUND(MIN(minute_min_travel_time))::FLOAT AS min_travel_time,
      ROUND(MAX(minute_max_travel_time))::FLOAT AS max_travel_time
